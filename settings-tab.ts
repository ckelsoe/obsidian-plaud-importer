...
export class PlaudImporterSettingsTab extends PluginSettingTab {
	...
	private renderBrowserSignInControl(setting: Setting): void {
		...
		const stepLines = [
			...
			'In the browser: sign in to Plaud if needed, then click the bookmark you saved. Your browser asks to open Obsidian; allow it, and the token is saved for you. Then close that Plaud browser tab so Obsidian holds the session on its own, and do not use Log Out in Plaud. Logging out ends the session for Obsidian too.',
